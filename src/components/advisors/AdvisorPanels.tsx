        ...
        {step === 0 ? (
          <div className="text-center">
            ...
            <p className="mt-3 text-[13px] leading-relaxed text-[var(--muted)]">
              {t(
                `${cityName} has appointed you Governor. Your charge: build a public-transport network the whole city can rely on — and pull people off the jammed roads.`,
                `${cityNameTh}แต่งตั้งท่านเป็นผู้ว่าราชการจังหวัด ภารกิจของท่านคือสร้างระบบขนส่งสาธารณะที่ทั้งเมืองพึ่งพาได้ — และดึงผู้คนออกจากถนนที่รถติด`,
              )}
            </p>
            {goalLabel ? (
